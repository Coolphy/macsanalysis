...
temp1 = ltData.plot(view_ax=12, bin_ax1=[-0.2,0.02,1.2], bin_ax2=[0.3,0.7], bin_ax3=[0.29,0.31], foldmode=12, plotflag=True,
                   marker='x',linestyle='None',
                   title="test", xlim=(0,1),ylim=(0,4))
temp2 = htData.plot(view_ax=12, bin_ax1=[-0.2,0.02,1.2], bin_ax2=[0.3,0.7], bin_ax3=[0.29,0.31], foldmode=12, plotflag=True,
                   marker='x',linestyle='None',
                   title="test", xlim=(0,1),ylim=(0,4))
tempsub = subtraction(temp1, temp2, plotmode=1,
            marker='x', linestyle='None',
            title="test", xlim=(0, 1), ylim=(0, 4),legend=(['LT','HT']))
tempsub.plot(marker='x',linestyle='None',title='subtraction',xlim=(0,1),ylim=(-1,1))
