...
temp = ltData.plot(view_ax=12, bin_ax1=[0,0.02,1], bin_ax2=[0,0.02,1], bin_ax3=[0.29,0.31], foldmode=12, plotflag=True,
                   marker='x',linestyle='None',
                   title="test",colorbar=True,clim=(0,2),xlim=(0,1),ylim=(0,1))
